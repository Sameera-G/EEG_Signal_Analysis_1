...
% !!! For the future, add corresponding titles and legends to the plots !!!
...
lp_signal = filter(FIR_LowPass,signal); % Your code here
...
% filter function
a = IIR_Notch_Filter().Denominator;
b = IIR_Notch_Filter().Numerator;% your code here
...
hp_signal = filter(FIR_HighPass,notch_signal); % your code here
...
% EOG1 (ch14):
for i=1:10; %10 iterations to stabilize the filter
...
% Transpose the input signal hp_signal
...
% Generated on: 28-Mar-2023 16:37:08
...
%****************************************************
% Notch Filter
function Hd = NotchFilterPLI_Removal
%NOTCHFILTERPLI_REMOVAL Returns a discrete-time filter object.

% MATLAB Code
% Generated by MATLAB(R) 9.11 and DSP System Toolbox 9.13.
% Generated on: 28-Mar-2023 16:44:47
...
%****************************************************
% High Pass Filter
function Hd = HighPassFilterTrendRemoval
%HIGHPASSFILTERTRENDREMOVAL Returns a discrete-time filter object.

% MATLAB Code
% Generated by MATLAB(R) 9.11 and DSP System Toolbox 9.13.
% Generated on: 28-Mar-2023 16:47:54
